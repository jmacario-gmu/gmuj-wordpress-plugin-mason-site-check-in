...
function gmuj_sci_detect_plugin_activation($plugin, $network_activation) {
    ...
    //set email subject and body
		$email_subject='Mason Site Check-In - Plugin Activated: '.$plugin.' / '.get_bloginfo('name').' ('.$_SERVER['HTTP_HOST'].')';
		$email_body='Mason Site Check-In - Plugin Activated: '.$plugin.' / '.get_bloginfo('name').' ('.$_SERVER['HTTP_HOST'].')';
...
function gmuj_sci_detect_plugin_deactivation($plugin, $network_activation) {
    ...
    //set email subject and body
		$email_subject='Mason Site Check-In - Plugin Deactivated: '.$plugin.' / '.get_bloginfo('name').' ('.$_SERVER['HTTP_HOST'].')';
		$email_body='Mason Site Check-In - Plugin Deactivated: '.$plugin.' / '.get_bloginfo('name').' ('.$_SERVER['HTTP_HOST'].')';
...
function gmuj_sci_detect_switch_theme($theme) {
    ...
    //set email subject and body
		$email_subject='Mason Site Check-In - Theme Switch: '.$theme.' / '.get_bloginfo('name').' ('.$_SERVER['HTTP_HOST'].')';
		$email_body='Mason Site Check-In - Theme Switch: '.$theme.' / '.get_bloginfo('name').' ('.$_SERVER['HTTP_HOST'].')';
